...
const Lighthouse = () => {
  ...
  return (
    <>
      <div
        className="lighthouse-back bg-stone-700 w-screen h-screen flex items-center relative overflow-hidden"
      ...
      >
        <div className="relative">
          <img src="../lighthouse.svg" alt="lighthouse" className="w-50" />
          <div
            className="light-beam-container absolute flex items-center"
            style={{ top: "3%", left: "30%" }}
          >
