  ...
  return (
    <>
      <div className=" justify-center pt-[100vh] w-screen h-[400vh] bg-zinc-950 text-white ">
        <div
          ref={imgRef}
          className="sticky-container h-[200vh] relative bg-zinc-900"
        >
          <motion.div className="sticky-content h-screen sticky top-0 overflow-hidden">
            <motion.div
            ...
            >
              <motion.div
                className="surround-img w-[25vw] h-[65vh] absolute right-0 top-1/3 -translate-x-1/3 -translate-y-1/2 bg-center bg-cover"
            ...
            >
              <motion.div
                className="surround-img w-[25vw] h-[30vh] absolute right-0 bottom-0 -translate-x-1/2 translate-y-0 bg-center bg-cover"
